...
public class OrderEventWorkerTest {
    ...
    public void setUp() throws Exception {
        String encounterJson = objectMapper.writeValueAsString(objectMapper.createObjectNode()
                .put("encounterUuid", "enc-1").put("patientUuid", "pat-1")
                .set("orders", objectMapper.createArrayNode()
                        .add(objectMapper.createObjectNode().put("uuid", "order-1").put("voided", false)
                                .put("type", "Test Order").set("concept",
                                        objectMapper.createObjectNode().put("uuid", "c-1").put("display", "Hb")))
                        .add(objectMapper.createObjectNode().put("uuid", "order-2").put("voided", true)
                                .put("type", "Test Order").set("concept",
                                        objectMapper.createObjectNode().put("uuid", "c-2").put("display", "Void")))));
    ...
    public void process_createsBahmniLabOrders() throws Exception {
        String encounterJson = objectMapper
                .writeValueAsString(objectMapper.createObjectNode().put("encounterUuid", "enc-bahmni")
                        .put("patientUuid", "pat-bahmni").set("orders",
                                objectMapper.createArrayNode()
                                        .add(objectMapper.createObjectNode().put("uuid", "order-lab-1")
                                                .put("voided", false).put("orderType", "Lab Order").put("action", "NEW")
                                                ...
                                                .set("concept", objectMapper.createObjectNode()
                                                        ...
                                                        .put("name", "CD4 Test").put("conceptClass", "LabTest")))));
    ...
    public void process_skipsNonTestOrders() throws Exception {
        String encounterJson = objectMapper
                .writeValueAsString(objectMapper.createObjectNode().put("encounterUuid", "enc-2").set("orders",
                        objectMapper.createArrayNode().add(objectMapper.createObjectNode().put("uuid", "order-3")
                                .put("voided", false).put("type", "Drug Order").set("concept",
                                        objectMapper.createObjectNode().put("uuid", "c-3").put("display", "Drug")))));
    ...
    public void process_skipsBahmniRadiologyOrders() throws Exception {
        String encounterJson = objectMapper
                .writeValueAsString(objectMapper.createObjectNode().put("encounterUuid", "enc-rad").set("orders",
                        objectMapper.createArrayNode()
                                .add(objectMapper.createObjectNode().put("uuid", "order-rad-1").put("voided", false)
                                        .put("orderType", "Radiology Order").put("action", "NEW")
                                        .set("concept", objectMapper.createObjectNode().put("uuid", "c-rad")
                                                .put("name", "CHEST Lateral").put("conceptClass", "Radiology")))));
